...
Shader "Custom/Enviroment/EnviromentStatic"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float2 uv_MainText1 = i.ase_texcoord1.xy;
				
				
				finalColor = ( tex2D( _MainText, uv_MainText1 ) * _Color );
				return finalColor;
			}
			ENDCG
		}
